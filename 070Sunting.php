              ...
              if (isset($_POST['update'])) {
                if (isset($_POST['nim']) && isset($_POST['namamhs']) && isset($_POST['jk']) && isset($_POST['alamat']) && isset($_POST['kota']) && isset($_POST['email']) && isset($_FILES['foto'])) {
                    ...
                    $foto_baru = $angka_acak.'-'.$data['foto'];
                        $data['baru'] = $foto_baru;
                        move_uploaded_file($file_tmp,'070Foto/'.$foto_baru);
                    }
                    ...
                    header("Location: 070Sunting.php?id=$id");
                  }
                }
          ...
          ?>
						<form action="" method="post" enctype="multipart/form-data">
							...
							<div class="mb-3">
								...
								<br> <img src="070Foto/<?php echo $row['foto'];?>" style="width: 120px; float:left; margin-bottom:5px;">
